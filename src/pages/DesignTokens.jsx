...
const TOKEN_VALUES = {
  minimal: {
    light: {
      ...
      'color-icon-default': '#141414',         'color-icon-subtle': '#4b4b4b',
      'color-icon-muted': '#919191',           'color-icon-disabled': '#d4d4d4',
      'color-icon-inverse': '#ffffff',         'color-icon-brand': '#141414',
      'color-icon-positive': '#15803d',        'color-icon-warning': '#a16207',
      'color-icon-danger': '#b91c1c',          'color-icon-info': '#1d4ed8',
    ...
    dark: {
      ...
      'color-icon-default': '#f5f5f5',         'color-icon-subtle': '#919191',
      'color-icon-muted': '#4b4b4b',           'color-icon-disabled': '#2e2e2e',
      'color-icon-inverse': '#141414',         'color-icon-brand': '#f5f5f5',
      'color-icon-positive': '#86efac',        'color-icon-warning': '#fde047',
      'color-icon-danger': '#fca5a5',          'color-icon-info': '#93c5fd',
  ...
  purpura: {
    light: {
      ...
      'color-icon-default': '#141414',         'color-icon-subtle': '#4b4b4b',
      'color-icon-muted': '#919191',           'color-icon-disabled': '#d4d4d4',
      'color-icon-inverse': '#ffffff',         'color-icon-brand': '#7e22ce',
      'color-icon-positive': '#15803d',        'color-icon-warning': '#a16207',
      'color-icon-danger': '#b91c1c',          'color-icon-info': '#1d4ed8',
    ...
    dark: {
      ...
      'color-icon-default': '#f5f5f5',         'color-icon-subtle': '#919191',
      'color-icon-muted': '#4b4b4b',           'color-icon-disabled': '#2e2e2e',
      'color-icon-inverse': '#141414',         'color-icon-brand': '#c084fc',
      'color-icon-positive': '#86efac',        'color-icon-warning': '#fde047',
      'color-icon-danger': '#fca5a5',          'color-icon-info': '#93c5fd',
  ...
  azure: {
    light: {
      ...
      'color-icon-default': '#141414',         'color-icon-subtle': '#4b4b4b',
      'color-icon-muted': '#919191',           'color-icon-disabled': '#d4d4d4',
      'color-icon-inverse': '#ffffff',         'color-icon-brand': '#0369a1',
      'color-icon-positive': '#15803d',        'color-icon-warning': '#a16207',
      'color-icon-danger': '#b91c1c',          'color-icon-info': '#1d4ed8',
    ...
    dark: {
      ...
      'color-icon-default': '#f5f5f5',         'color-icon-subtle': '#919191',
      'color-icon-muted': '#4b4b4b',           'color-icon-disabled': '#2e2e2e',
      'color-icon-inverse': '#141414',         'color-icon-brand': '#38bdf8',
      'color-icon-positive': '#86efac',        'color-icon-warning': '#fde047',
      'color-icon-danger': '#fca5a5',          'color-icon-info': '#93c5fd',
